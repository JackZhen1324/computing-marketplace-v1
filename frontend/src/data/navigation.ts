...
export const footerLinks = {
  product: {
    title: '产品中心',
    links: [
      { label: 'GPU裸金属', path: '/intelligent-computing/gpu-bare-metal' },
      { label: 'GPU云主机', path: '/intelligent-computing/gpu-cloud' },
      { label: '智算一体机', path: '/intelligent-computing/appliance' },
